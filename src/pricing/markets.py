...
from src.pricing.odds import decimal_to_american, edge_vs_market, expected_value, implied_prob_to_decimal, remove_vig_two_way
...
def price_match_winner_market(df: pd.DataFrame, model_prob_col: str = "model_prob_p1") -> pd.DataFrame:
    ...
    out["fair_odds_decimal_p1"] = out[model_prob_col].apply(implied_prob_to_decimal)
